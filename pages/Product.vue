      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <h5 class="w-[100%] text-[22px] xs:!text-[14px] sm:!text-[16px] text-[#7CB118] font-bold mb-5">100
              SAR</h5>
            ...
            <p class="w-[100%] flex items-center xs:!text-[10px] sm:!text-[10px] mb-5"><img
            ...
            <h4 class="w-[100%] text-[22px] xs:!text-[14px] sm:!text-[14px] text-[#000000] font-bold mb-5">Quick
              Overview</h4>
            <p class="w-[100%] text-[#838383] text-[16px] xs:!text-[12px] sm:!text-[12px]">Lorem ipsum dolor sit
              amet, consectetur adipiscing
              elit. Aliquam
              auctor a tellus
              et sodales.
              Pellentesque vel hendrerit dui. Curabitur molestie lacus eu eros placerat fermentum. Maecenas
              semper nunc turpis, a sagittis urna mattis eget. </p>
          </div>
        </div>
      </div>
    </section>
