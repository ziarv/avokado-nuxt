<template>
  <div class="product_1 sm:!h-[80px] overflow-hidden">
    ...
    <div class="product_btn sm:!w-[23%]">
      <button
class="add_product addShow_product sm:!text-[12px] sm:!py-[0px] sm:!px-[5px]"
              style="border-bottom-right-radius: 0 !important; " @click="remove"><i
        class="fa-solid fa-minus"></i></button>
      <input
v-model="qty_in_cart" type="text"
             class="add_product addShow_product sm:!w-[28px] sm:!w-[28px] sm:!rounded-none sm:!rounded-none">
      <button
class="add_product addShow_product sm:!text-[12px] sm:!py-[0px] sm:!px-[5px]"
              style="border-top-left-radius: 0 !important; " @click="add"><i
