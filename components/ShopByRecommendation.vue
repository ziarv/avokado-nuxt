<template>
  <section>
    <div
      ...
      <div ref="swiper" class="swiper mySwiper_12 mySwiper_2">
        ...
        <div class="swiper-button-prev xs:!w-[20px] xs:!h-[20px] xs:!top-[80%] sm:!w-[20px] sm:!h-[20px] sm:!top-[80%] xs:!right-[40px] sm:!right-[40px]">
